...
export interface RustPayload {
    ...
    gpu_stats: { gpu_usage: number, gpu_temp: number, gpu_max_temp:number, vram_used: number, 
       fan_speed_pct: number, power_draw_w:number,gpu_mhz:number, needs_static_update:boolean};
